    ...
    <div class="row justify-content-center">
        <div class="col-lg-5">
            <div class="glass p-4 p-lg-5">
                <h1 class="h3 fw-bold mb-3">Vendor Registration</h1>
                ...
                <form method="post" action="<?= url('vendor/register') ?>" class="vstack gap-3">
                    <?= csrf_field() ?>
                    ...
                    <button class="btn btn-primary">Apply as Vendor</button>
                </form>
            </div>
        </div>
    </div>
